...
package Format_Strings.Common is
   ...
   function Format_FF is new
     Format_2 (Float, Float, Float_Formatter, Float_Formatter);
   function Format_FB is new
     Format_2 (Float, Boolean, Float_Formatter, Formatters.Boolean_Formatter);
   function Format_BS
     (Template : String; Arg1 : Boolean; Arg2 : String) return String;
   function Format_BI is new
     Format_2
       (Boolean,
        Integer,
        Formatters.Boolean_Formatter,
        Integer_Formatter);
   function Format_BF is new
     Format_2 (Boolean, Float, Formatters.Boolean_Formatter, Float_Formatter);
   function Format_BB is new
     Format_2
       (Boolean,
        Boolean,
        Formatters.Boolean_Formatter,
        Formatters.Boolean_Formatter);
   function Format_IB is new
     Format_2
       (Integer,
        Boolean,
        Integer_Formatter,
   ...
   function Format
     (Template : String; Arg1 : String; Arg2 : Integer; Arg3 : String)
      return String renames Format_SIS;
   function Format
     (Template : String; Arg1 : String; Arg2, Arg3 : Integer) return String
   renames Format_SII;
   function Format
     (Template : String; Arg1 : String; Arg2 : Integer; Arg3 : Float)
      return String renames Format_SIF;
   function Format
     (Template : String; Arg1 : String; Arg2 : Integer; Arg3 : Boolean)
      return String renames Format_SIB;
   function Format
     (Template : String; Arg1 : String; Arg2 : Float; Arg3 : String)
      return String renames Format_SFS;
   function Format
     (Template : String; Arg1 : String; Arg2 : Float; Arg3 : Integer)
      return String renames Format_SFI;
   function Format
     (Template : String; Arg1 : String; Arg2, Arg3 : Float) return String
   renames Format_SFF;
   function Format
     (Template : String; Arg1 : String; Arg2 : Float; Arg3 : Boolean)
      return String renames Format_SFB;
   function Format
     (Template : String; Arg1 : String; Arg2 : Boolean; Arg3 : String)
      return String renames Format_SBS;
   function Format
     (Template : String; Arg1 : String; Arg2 : Boolean; Arg3 : Integer)
      return String renames Format_SBI;
   function Format
     (Template : String; Arg1 : String; Arg2 : Boolean; Arg3 : Float)
      return String renames Format_SBF;
   function Format
     (Template : String; Arg1 : String; Arg2, Arg3 : Boolean) return String
   renames Format_SBB;
   function Format
   ...
   function Format
     (Template : String; Arg1 : Integer; Arg2 : String; Arg3 : Integer)
      return String renames Format_ISI;
   function Format
     (Template : String; Arg1 : Integer; Arg2 : String; Arg3 : Float)
      return String renames Format_ISF;
   function Format
     (Template : String; Arg1 : Integer; Arg2 : String; Arg3 : Boolean)
      return String renames Format_ISB;
   function Format
     (Template : String; Arg1, Arg2 : Integer; Arg3 : String) return String
   renames Format_IIS;
   function Format (Template : String; Arg1, Arg2, Arg3 : Integer) return String
   renames Format_III;
   function Format
   ...
   function Format
     (Template : String; Arg1 : Float; Arg2 : String; Arg3 : Integer)
      return String renames Format_FSI;
   function Format
     (Template : String; Arg1 : Float; Arg2 : String; Arg3 : Float)
      return String renames Format_FSF;
   function Format
     (Template : String; Arg1 : Float; Arg2 : String; Arg3 : Boolean)
      return String renames Format_FSB;
   function Format
     (Template : String; Arg1 : Float; Arg2 : Integer; Arg3 : String)
      return String renames Format_FIS;
   function Format
     (Template : String; Arg1 : Float; Arg2, Arg3 : Integer) return String
   renames Format_FII;
   function Format
     (Template : String; Arg1 : Float; Arg2 : Integer; Arg3 : Float)
      return String renames Format_FIF;
   function Format
     (Template : String; Arg1 : Float; Arg2 : Integer; Arg3 : Boolean)
      return String renames Format_FIB;
   function Format
     (Template : String; Arg1, Arg2 : Float; Arg3 : String) return String
   renames Format_FFS;
   function Format
   ...
   function Format
     (Template : String; Arg1 : Float; Arg2 : Boolean; Arg3 : String)
      return String renames Format_FBS;
   function Format
     (Template : String; Arg1 : Float; Arg2 : Boolean; Arg3 : Integer)
      return String renames Format_FBI;
   function Format
   ...
   renames Format_BBF;
   function Format (Template : String; Arg1, Arg2, Arg3 : Boolean) return String
   renames Format_BBB;
